...
type ModifyInstanceAttributeOptions struct {
	BlockDeviceMappings   []BlockDeviceMapping
	DisableAPITermination *bool
	EbsOptimized          *bool
	SecurityGroups        []SecurityGroup
...
func (ec2 *EC2) DescribeInstanceAttribute(instId string, attribute string) (resp *DescribeInstanceAttributeResponse, err error) {
...
func (ec2 *EC2) ModifyInstanceAttribute(instId string, options *ModifyInstanceAttributeOptions) (resp *ModifyInstanceAttributeResponse, err error) {
